...
import { storeProducts, categories as storeCategories } from '@/data/storeProducts';
import { spaces, spaceCategories } from '@/data/spaceData';
...
export default function Home() {
  ...
  // Show only category cards if no category selected
  if (!selectedCategory) {
    return (
          ...
          <div className="relative max-w-7xl mx-auto">
            <div className="text-center mb-20 animate-fade-in">
              <div className="inline-flex items-center gap-2 mb-8 px-6 py-3 rounded-full bg-gradient-to-r from-[var(--primary)]/20 to-[var(--accent)]/20 backdrop-blur-sm border border-[var(--primary)]/30 shadow-lg">
                ...
                <span className="text-[var(--primary)] font-semibold">Welcome to Our Platform</span>
              </div>
  ...
  return (
      <div className="min-h-screen bg-[var(--surface)]">
        ...
        <header className="sticky top-0 z-50 bg-[var(--surface)]/95 backdrop-blur-xl border-b border-[var(--border)]/50 shadow-lg">
          <div className="max-w-7xl mx-auto px-4 lg:px-6">
            {/* Top Bar */}
            <div className="flex items-center justify-between py-4">
              <Link href="/" onClick={() => setSelectedCategory(null)} className="text-3xl font-extrabold text-gradient-primary hover:scale-105 transition-transform duration-300">
                MSME Store
              </Link>
              ...
              <div className="flex items-center gap-4">
                <Link href="/account" className="flex flex-col items-center hover:text-[var(--primary)] transition-colors">
                  <span className="text-xs text-[var(--text-secondary)]">Hello, Sign in</span>
                  <span className="text-sm font-semibold">Account & Lists</span>
                </Link>
                <Link href="/cart" className="relative flex items-center gap-1 hover:text-[var(--primary)] transition-colors">
            ...
            <div className="flex items-center gap-3 py-3 overflow-x-auto scrollbar-hide">
              <button
                ...
                className="flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-[var(--surface-light)] to-[var(--surface)] hover:from-[var(--primary)]/20 hover:to-[var(--accent)]/20 border border-[var(--border)]/50 hover:border-[var(--primary)]/50 transition-all duration-300 min-h-[48px] whitespace-nowrap font-semibold shadow-md hover:shadow-lg"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {storeCategories.map((cat) => (
                <button
                  ...
                  className={`px-6 py-3 rounded-xl font-semibold min-h-[48px] transition-all duration-300 whitespace-nowrap shadow-md hover:shadow-lg ${
                    selectedStoreCategory === cat.id
                      ? 'bg-gradient-to-r from-[var(--primary)] to-[#0a6269] text-white scale-105 shadow-xl'
                      : 'bg-[var(--surface-light)]/80 backdrop-blur-sm text-[var(--text-primary)] hover:bg-[var(--border)]/50 border border-[var(--border)]/50'
                  }`}
                >
  ...
  if (selectedCategory === 'service') {
    return (
      <div className="min-h-screen bg-[var(--surface)]">
        ...
        {/* Service Header - Enhanced Design */}
        <header className="sticky top-0 z-50 bg-[var(--surface)]/95 backdrop-blur-xl border-b border-[var(--border)]/50 shadow-lg">
          <div className="max-w-7xl mx-auto px-4 lg:px-6">
            <div className="flex items-center justify-between py-4">
              <Link href="/" onClick={() => setSelectedCategory(null)} className="text-3xl font-extrabold text-gradient-primary hover:scale-105 transition-transform duration-300">
              ...
              {/* Right Side Icons */}
              <div className="flex items-center gap-4">
                <Link href="/account" className="flex flex-col items-center hover:text-[var(--accent)] transition-colors">
                  <span className="text-xs text-[var(--text-secondary)]">Hello, Sign in</span>
                  <span className="text-sm font-semibold">Account & Bookings</span>
                </Link>
                <Link href="/cart" className="relative flex items-center gap-1 hover:text-[var(--accent)] transition-colors">
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-xl font-semibold min-h-[48px] transition-all duration-300 whitespace-nowrap shadow-md hover:shadow-lg ${
                    selectedServiceCategory === cat.id
                      ? 'bg-gradient-to-r from-[var(--accent)] to-[#e8b04f] text-[var(--neutral)] scale-105 shadow-xl'
                      : 'bg-[var(--surface-light)]/80 backdrop-blur-sm text-[var(--text-primary)] hover:bg-[var(--border)]/50 border border-[var(--border)]/50'
                  }`}
                >
                  <span className="text-lg mr-2">{cat.icon}</span>
            ...
            {filteredServices.map((service) => {
              ...
              <Card key={service.id} variant="elevated" className="relative p-0 hover-lift group overflow-hidden border-2 border-[var(--border)]/50 hover:border-[var(--accent)]/50 transition-all duration-500 bg-gradient-to-br from-[var(--surface)] to-[var(--surface-light)]">
                ...
                >
                  ...
                  <span className="relative z-10">Book Slots</span>
                </button>
                </div>
              </Card>
            );
        ...
        <header className="sticky top-0 z-50 bg-[var(--surface)]/95 backdrop-blur-xl border-b border-[var(--border)]/50 shadow-lg">
          <div className="max-w-7xl mx-auto px-4 lg:px-6">
            ...
            <div className="flex items-center justify-between py-4">
              ...
              {/* Right Side Icons */}
              <div className="flex items-center gap-4">
                <Link href="/account" className="flex flex-col items-center hover:text-[var(--info)] transition-colors">
                  <span className="text-xs text-[var(--text-secondary)]">Hello, Sign in</span>
                  <span className="text-sm font-semibold">Account & Bookings</span>
                </Link>
                <Link href="/cart" className="relative flex items-center gap-1 hover:text-[var(--info)] transition-colors">
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                  </svg>
                  <span className="text-sm font-semibold">Bookings</span>
            ...
            <div className="flex items-center gap-3 py-3 overflow-x-auto scrollbar-hide">
              <button
                ...
                className="flex items-center gap-2 px-5 py-3 rounded-xl bg-gradient-to-r from-[var(--surface-light)] to-[var(--surface)] hover:from-[var(--info)]/20 hover:to-[var(--primary)]/20 border border-[var(--border)]/50 hover:border-[var(--info)]/50 transition-all duration-300 min-h-[48px] whitespace-nowrap font-semibold shadow-md hover:shadow-lg"
              >
                <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z" />
                </svg>
                ...
                <button
                  ...
                  className={`px-6 py-3 rounded-xl font-semibold min-h-[48px] transition-all duration-300 whitespace-nowrap shadow-md hover:shadow-lg ${
                    selectedSpaceCategory === cat.id
                      ? 'bg-gradient-to-r from-[var(--info)] to-[#2563eb] text-white scale-105 shadow-xl'
                      : 'bg-[var(--surface-light)]/80 backdrop-blur-sm text-[var(--text-primary)] hover:bg-[var(--border)]/50 border border-[var(--border)]/50'
                  }`}
                >
                  <span className="text-lg mr-2">{cat.icon}</span>
            ...
            {filteredSpaces.map((space) => {
              ...
              <Card key={space.id} variant="elevated" className="relative p-0 hover-lift group overflow-hidden border-2 border-[var(--border)]/50 hover:border-[var(--info)]/50 transition-all duration-500 bg-gradient-to-br from-[var(--surface)] to-[var(--surface-light)]">
                ...
                <button
                  type="button"
                  onClick={() => {
                    setSpaceBookingCount((prev) => prev + 1);
                    // TODO: Add to booking cart logic
                  }}
                ...
                >
                  ...
                  <span className="relative z-10">
                    {space.type === 'movie' || space.type === 'movie-theater' ? 'Book Seats' :
                     space.type === 'banquet-hall' ? 'Book Banquet' :
                     space.type === 'convention-hall' ? 'Book Convention' :
                     space.type === 'function-hall' ? 'Book Function' :
                     space.type === 'concert-venue' ? 'Book Concert' :
                     space.type === 'hotel' ? 'Book Hotel' :
                     space.type === 'wedding-hall' ? 'Book Wedding' :
                     space.type === 'conference' ? 'Book Conference' :
                     space.type === 'event-venue' ? 'Book Event' :
                     'Book'}
                  </span>
                </button>
                </div>
